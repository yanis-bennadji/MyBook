  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="pt-24">
        ...
        {/* Notre mission */}
        <section id="notre-mission" className="py-16 md:py-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl md:text-4xl font-bold text-center text-[#0F3D3E] mb-8 animate-fade-in">
              Notre mission
            </h2>
            <p className="text-lg text-gray-600 text-center max-w-3xl mx-auto animate-fade-in delay-100">
              Chez MyBook, nous croyons que chaque livre a le pouvoir de transformer des vies. 
              Notre plateforme est conçue pour connecter les lecteurs, partager des histoires 
              et créer une communauté passionnée par la littérature.
            </p>
          </div>
        </section>
      </main>
